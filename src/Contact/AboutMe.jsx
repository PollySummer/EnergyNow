...
function AboutMe() {
    ...
    return (
        <div className='aboutMe w-75 m-auto mt-5'>
            ...
            <p >I learn HTML5, CSS3 Node.js and React with GammaIntelligence courses. I already learnt such frameworks as Bootstrap and SCSS. I chose this field because I like combining of programming and design in one speciality.
